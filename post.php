...
// Fetch the post from the database => Fetch single record 
$post = $stmt->fetch();
?>
...
<body class="bg-gray-100">
  ...
  <div class="container mx-auto p-4 mt-4">
    <div class="md my-4">
      ...
      <!-- Update/Edit Button -->
      <a href="edit.php?id=<?= $post['id'] ?>" class="
      mt-4 
      block w-full bg-green-600 rounded hover:bg-green-700 text-white text-center 
      ...
      <!-- Delete Form -->
      <!-- NOTE: We can;t make the method="delete" -->
